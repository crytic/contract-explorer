...
export class Logger {
  ...
  public static error(
    msg: string | Error | ResponseError<any>,
    ...
    if (msg instanceof ResponseError) {
      ...
      else if (msg.code == ErrorCodes.InvalidRequest)
        codeStr = "InvalidRequest";
      else if (msg.code == ErrorCodes.ParseError) codeStr = "ParseError";
      else if (msg.code == ErrorCodes.MethodNotFound)
        codeStr = "MethodNotFound";
      else if (msg.code == ErrorCodes.MessageReadError)
        codeStr = "MessageReadError";
      else if (msg.code == ErrorCodes.MessageWriteError)
        codeStr = "MessageWriteError";
      else if (msg.code == ErrorCodes.ServerNotInitialized)
        codeStr = "ServerNotInitialized";
      else if (msg.code == ErrorCodes.UnknownErrorCode)
